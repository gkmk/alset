...
// -------------------- EDIT THESE ----------------- //
$images = array(
  'куќата'=> 'scripts/captcha/captchaImages/01.png',
  'клучот'=> 'scripts/captcha/captchaImages/04.png',
  'знамето'=> 'scripts/captcha/captchaImages/06.png',
  'часовникот'=> 'scripts/captcha/captchaImages/15.png',
  'бубачката'=> 'scripts/captcha/captchaImages/16.png',
  'пенкалото'=> 'scripts/captcha/captchaImages/19.png',
  'светилката'=> 'scripts/captcha/captchaImages/21.png',
  'нотата'=> 'scripts/captcha/captchaImages/40.png',
  'срцето'=> 'scripts/captcha/captchaImages/43.png',
  'светот'=> 'scripts/captcha/captchaImages/99.png'
);
// ------------------- STOP EDITING ---------------- //
